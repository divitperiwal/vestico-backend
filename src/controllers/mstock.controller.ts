import { generateMStockAccessToken , getEtfFromPortfolio, getMstockFunds, getMstockPortfolio, getStockFromPortfolio} from "@/services/mstock.service.js";
import { asyncHandler } from "@/utils/asyncHandler.js";
import { sendSuccess } from "@/utils/response.js";


export const handleGetMstockPortfolio = asyncHandler(async (req, res) => {
    const portfolio = await getMstockPortfolio(req.accessToken!, req.apiKey!);
...
export const handleGetMstockFunds = asyncHandler(async (req, res) => {
    const funds = await getMstockFunds(req.accessToken!, req.apiKey!);
